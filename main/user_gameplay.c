...
void create_starting_menu(void) {
    ...
    *physical = 'p';
    ...
    lv_obj_t *physical_label = lv_label_create(btn1);
    lv_label_set_text(physical_label, "PHYSICAL PIECE MOVEMENT");
    
    lv_obj_t *rook_label = lv_label_create(btn1);
    lv_obj_set_style_text_font(rook_label, &Spec_size_font_60, 0);
    lv_label_set_text(rook_label, "♜");
    ...
    *user = 'u';
    ...
    lv_obj_t *user_interface_label = lv_label_create(btn2);
    lv_label_set_text(user_interface_label, "USER INTERFACE");

    lv_obj_t *ui_image = lv_label_create(btn2);
    lv_obj_set_style_text_font(ui_image, &Spec_size_font_60, 0);
    lv_label_set_text(ui_image, "⌨");
    ...
    *wifi = 'w';
    ...
    lv_obj_t *online_text_label = lv_label_create(btn3);
    lv_label_set_text(online_text_label, "ONLINE");
